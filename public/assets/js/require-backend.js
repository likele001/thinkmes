require.config({
    ...
    include: ['css', 'layer', 'toastr', 'fast', 'backend', 'backend-init', 'table', 'form', 'dragsort', 'addtabs', 'selectpage', 'bootstrap-daterangepicker', 'backend-loader', 'css!backend.css'], // 添加 backend-loader 和 css!backend.css
    paths: {
        'lang': "empty:",
        'form': 'require-form',
        'table': 'require-table',
        ...
        'backend-loader': 'backend-loader', // 添加 backend-loader 路径
        //
        // 以下的包从bower的libs目录加载
...
require(['jquery', 'bootstrap'], function ($, undefined) {
    ...
    // 初始化
    $(function () {
        require(['fast', 'backend-loader', 'css!backend.css'], function (Fast, BackendLoader) { // 加载 backend-loader 和 backend.css
