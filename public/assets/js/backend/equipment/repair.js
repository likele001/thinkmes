    ...
    var Controller = {
        index: function () {
            ...
            table.bootstrapTable({
                url: base + '/equipment/repair/index',
                method: 'get',
                ...
                columns: [
                    ...
                    { field: 'fault_desc', title: '故障描述', align: 'left' },
                    { field: 'repair_date', title: '维修日期', width: 100 },
                    { field: 'cost', title: '费用', width: 100 },
                    { field: 'operate', title: '操作', width: 120, formatter: function (v, row) {
                        return '<a href="' + base + '/equipment/repair/edit?id=' + row.id + '" class="btn btn-xs btn-success">编辑</a> <a href="javascript:;" class="btn btn-xs btn-danger btn-del" data-id="' + row.id + '">删除</a>';
                    }}
                ]
            });
