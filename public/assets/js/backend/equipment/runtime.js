    ...
    var Controller = {
        index: function () {
            ...
            table.bootstrapTable({
                url: base + '/equipment/runtime/index',
                method: 'get',
                ...
                columns: [
                    ...
                    { field: 'run_date', title: '日期', width: 100 },
                    { field: 'plan_hours', title: '计划工时', width: 100 },
                    { field: 'run_hours', title: '运行工时', width: 100 },
                    { field: 'down_hours', title: '停机工时', width: 100 },
                    { field: 'operate', title: '操作', width: 120, formatter: function (v, row) {
                        return '<a href="' + base + '/equipment/runtime/edit?id=' + row.id + '" class="btn btn-xs btn-success">编辑</a> <a href="javascript:;" class="btn btn-xs btn-danger btn-del" data-id="' + row.id + '">删除</a>';
                    }}
                ]
            });
            ...
            $(document).off('click', '.btn-del').on('click', '.btn-del', function () {
                ...
                $.post(base + '/equipment/runtime/del', { ids: id }, function (r) { if (r.code == 1) { table.bootstrapTable('refresh'); alert(r.msg || '删除成功'); } else alert(r.msg || '删除失败'); }, 'json');
            });
        },
        add: function () {},
        edit: function () {}
