    ...
    var Controller = {
        index: function () {
            ...
            table.bootstrapTable({
                url: base + '/restaurant/option_group/index',
                method: 'get',
                ...
                columns: [
                    ...
                    { field: 'item_name', title: '菜品', width: 180 },
                    { field: 'name', title: '分组名称', align: 'left' },
                    { field: 'required', title: '必选', width: 80, formatter: function (v) { return v == 1 ? '<span class="badge badge-primary">是</span>' : '<span class="badge badge-secondary">否</span>'; } },
                    { field: 'min_select', title: '最少', width: 70 },
                    { field: 'max_select', title: '最多', width: 70 },
                    ...
                    { field: 'operate', title: '操作', width: 140, formatter: function (v, row) {
                        return '<a href="' + base + '/restaurant/option_group/edit?id=' + row.id + '" class="btn btn-xs btn-success">编辑</a> <a href="javascript:;" class="btn btn-xs btn-danger btn-del" data-id="' + row.id + '">删除</a>';
                    } }
                ]
            });
            ...
            $(document).off('click', '.btn-del').on('click', '.btn-del', function () {
                ...
                $.post(base + '/restaurant/option_group/del', { ids: id }, function (r) {
