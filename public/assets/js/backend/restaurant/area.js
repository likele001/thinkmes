    ...
    var Controller = {
        index: function () {
            ...
            table.bootstrapTable({
                url: base + '/restaurant/area/index',
                method: 'get',
                ...
                columns: [
                    ...
                    { field: 'name', title: '区域名称', align: 'left' },
                    ...
                    { field: 'operate', title: '操作', width: 140, formatter: function (v, row) {
                        return '<a href="' + base + '/restaurant/area/edit?id=' + row.id + '" class="btn btn-xs btn-success">编辑</a> <a href="javascript:;" class="btn btn-xs btn-danger btn-del" data-id="' + row.id + '">删除</a>';
                    } }
                ]
            });
            ...
            $(document).off('click', '.btn-del').on('click', '.btn-del', function () {
                ...
                $.post(base + '/restaurant/area/del', { ids: id }, function (r) {
