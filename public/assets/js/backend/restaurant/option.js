    ...
    var Controller = {
        index: function () {
            ...
            table.bootstrapTable({
                url: base + '/restaurant/option/index',
                method: 'get',
                ...
                columns: [
                    ...
                    { field: 'group_name', title: '分组', width: 180 },
                    { field: 'name', title: '选项名称', align: 'left' },
                    { field: 'price_delta', title: '加价', width: 90, formatter: function (v) { return v != null ? parseFloat(v).toFixed(2) : '0.00'; } },
                    ...
                    { field: 'operate', title: '操作', width: 140, formatter: function (v, row) {
                        return '<a href="' + base + '/restaurant/option/edit?id=' + row.id + '" class="btn btn-xs btn-success">编辑</a> <a href="javascript:;" class="btn btn-xs btn-danger btn-del" data-id="' + row.id + '">删除</a>';
                    } }
                ]
            });
            ...
            $(document).off('click', '.btn-del').on('click', '.btn-del', function () {
                ...
                $.post(base + '/restaurant/option/del', { ids: id }, function (r) {
