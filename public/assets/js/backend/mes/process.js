...
(function () {
    ...
    var indexUrl = base + '/mes/process/index';
    var addUrl = base + '/mes/process/add';
    var editUrl = base + '/mes/process/edit';
    var delUrl = base + '/mes/process/del';
    ...
    var Controller = {
        index: function () {
            ...
            $table.bootstrapTable({
                ...
                columns: [
                    ...
                    {field: 'name', title: '工序名称', align: 'left'},
                    {field: 'code', title: '工序编码', align: 'left'},
        ...
        api: {
            bindevent: function () {
                ...
                if (form.length) {
                    var action = form.attr('action') || (form.attr('id') === 'form-add' ? (base + '/mes/process/add') : (base + '/mes/process/edit'));
                    ...
                    form.on('submit', function (e) {
                        ...
                        $.post(url, $(this).serialize(), function (r) {
                            ...
                            if (r && r.code === 1) {
                                location.href = base + '/mes/process/index';
                            }
