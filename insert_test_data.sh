...
-- 工序数据
INSERT INTO `fa_mes_process` (`tenant_id`, `name`, `code`, `status`, `create_time`, `update_time`) VALUES
(0, '切割工序', 'PROC001', 'active', UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(0, '焊接工序', 'PROC002', 'active', UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(0, '组装工序', 'PROC003', 'active', UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(0, '质检工序', 'PROC004', 'active', UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(0, '包装工序', 'PROC005', 'active', UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
