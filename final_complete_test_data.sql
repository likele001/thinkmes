...
-- 订单1（租户7）
INSERT INTO `fa_mes_order` (`tenant_id`, `order_no`, `customer_id`, `order_name`, `total_quantity`, `production_progress`, `shipment_status`, `delivery_time`, `status`, `create_time`, `update_time`) VALUES
...
-- 订单1的发货
INSERT INTO `fa_mes_shipment` (`tenant_id`, `shipment_no`, `customer_id`, `order_id`, `quantity`, `ship_date`, `shipment_status`, `status`, `create_time`, `update_time`) VALUES
(7, 'SHP7-001', 1, 1, 50, UNIX_TIMESTAMP() + 86400 * 3, 'shipped', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
...
-- 订单2的发货
INSERT INTO `fa_mes_shipment` (`tenant_id`, `shipment_no`, `customer_id`, `order_id`, `quantity`, `ship_date`, `shipment_status`, `status`, `create_time`, `update_time`) VALUES
(8, 'SHP8-001', 1, 1, 50, UNIX_TIMESTAMP() + 86400 * 3, 'shipped', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
