<?php /*a:1:{s:66:"/www/wwwroot/thinkmes/app/index/view/tenant_register/register.html";i:1770798102;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="form-box">
            ...
            <form id="registerForm" method="post" action="/index/tenant_register/submit">
                ...
                <div class="form-group">
                    <label>* 登录账号</label>
                    <input type="text" name="login_account" required placeholder="请输入登录账号（字母、数字、下划线）" pattern="[a-zA-Z0-9_]+">
                </div>

                <div class="form-group">
                    <label>* 登录密码</label>
                    <input type="password" name="login_password" required placeholder="请输入登录密码（至少6位）" minlength="6">
                </div>
                ...
                <div class="hint">
                    ...
                    1. 登录账号：由您自定义设置，用于登录后台系统<br>
                    2. 登录密码：由您自己设置，请妥善保管<br>
                    3. 审核通过后，请使用您设置的账号密码登录系统<br>
                    提交后，平台管理员会审核您的申请。
                </div>
            </form>
        </div>
