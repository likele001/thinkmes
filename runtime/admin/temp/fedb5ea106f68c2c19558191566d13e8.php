<?php /*a:1:{s:62:"/www/wwwroot/thinkmes/app/admin/view/tenant_package/index.html";i:1770115478;}*/ ?>
<div class="card panel-intro">
    <div class="card-header">
        <div class="panel-lead"><em>套餐管理</em> 管理租户套餐配置</div>
    </div>
    <div class="card-body">
        <div id="toolbar" class="toolbar mb-2">
            ...
            <a href="<?php echo url('tenant_package/add'); ?>" class="btn btn-success btn-add" title="添加"><i class="fas fa-plus"></i> 添加套餐</a>
