<?php /*a:1:{s:59:"/www/wwwroot/thinkmes/app/admin/view/mes/quality/check.html";i:1771056859;}*/ ?>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <form id="form-search" class="form-inline" action="<?php echo url('mes/quality/check'); ?>" method="get">
...
$(function() {
    ...
    table.bootstrapTable({
        url: '<?php echo url("mes/quality/check"); ?>',
        method: 'get',
        pagination: true,
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row, index) {
                    var html = '';
                    html += '<a href="<?php echo url("mes/quality/addCheck"); ?>?report_id=' + row.report_id + '" class="btn btn-xs btn-primary" title="详情"><i class="fas fa-eye"></i></a> ';
                    return html;
                }
            }
        ],
