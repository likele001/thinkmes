<?php /*a:1:{s:60:"/www/wwwroot/thinkmes/app/admin/view/mes/supplier/index.html";i:1770960240;}*/ ?>
<div class="card panel-intro">
    <div class="card-header">
        <div class="panel-lead"><em>供应商管理</em> 管理供应商信息</div>
    </div>
    <div class="card-body">
        <div id="toolbar" class="toolbar mb-2">
            ...
            <a href="<?php echo htmlentities((string) $config['moduleurl']); ?>/mes/supplier/add" class="btn btn-success btn-add" title="添加"><i class="fas fa-plus"></i> 添加供应商</a>
