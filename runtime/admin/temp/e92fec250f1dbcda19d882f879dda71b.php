<?php /*a:1:{s:54:"/www/wwwroot/thinkmes/app/admin/view/tenant/index.html";i:1769948807;}*/ ?>
<div class="card panel-intro">
    <div class="card-header">
        <div class="panel-lead"><em>租户管理</em> 管理平台租户、域名与套餐</div>
    </div>
    <div class="card-body">
        <div id="toolbar" class="toolbar mb-2">
            ...
            <a href="<?php echo url('tenant/add'); ?>" class="btn btn-success btn-add" title="添加"><i class="fas fa-plus"></i> 添加租户</a>
