<?php /*a:1:{s:52:"/www/wwwroot/thinkmes/app/admin/view/role/index.html";i:1769852536;}*/ ?>
<div class="card panel-intro">
    <div class="card-header">
        <div class="panel-lead"><em>角色管理</em> 管理后台角色与权限</div>
    </div>
    <div class="card-body">
        <div id="toolbar" class="toolbar mb-2">
            ...
            <a href="<?php echo url('role/add'); ?>" class="btn btn-success btn-add" title="添加"><i class="fas fa-plus"></i> 添加</a>
