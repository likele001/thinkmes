<?php /*a:1:{s:59:"/www/wwwroot/thinkmes/app/admin/view/mes/process/index.html";i:1770200433;}*/ ?>
<div class="card panel-intro">
    <div class="card-header">
        <div class="panel-lead"><em>工序管理</em> 管理生产工序信息</div>
    </div>
    <div class="card-body">
        <div id="toolbar" class="toolbar mb-2">
            ...
            <a href="<?php echo htmlentities((string) $config['moduleurl']); ?>/mes/process/add" class="btn btn-success btn-add" title="添加"><i class="fas fa-plus"></i> 添加工序</a>
