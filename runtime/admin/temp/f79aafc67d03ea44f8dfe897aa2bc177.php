<?php /*a:1:{s:65:"/www/wwwroot/thinkmes/app/admin/view/mes/order/material_list.html";i:1771637722;}*/ ?>
        ...
        <table id="table" class="table table-striped table-bordered table-hover" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if($vo['shortage'] > 0): ?>
                        <span class="text-danger"><?php echo htmlentities((string) $vo['shortage']); ?></span>
                        <?php else: ?>
                        0
                        <?php endif; ?>
                    </td>
