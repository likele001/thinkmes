<?php /*a:1:{s:60:"/www/wwwroot/thinkmes/app/admin/view/mes/customer/index.html";i:1771804503;}*/ ?>
<div class="card panel-intro">
    ...
    <div class="card-body">
        <div id="toolbar" class="toolbar mb-2">
            ...
            <a href="<?php echo htmlentities((string) $config['moduleurl']); ?>/mes/customer/add" class="btn btn-success btn-add" title="添加"><i class="fas fa-plus"></i> 添加客户</a>
    ...
    function init() {
        ...
        table.bootstrapTable({
            ...
            columns: [
                ...
                {field: 'contact_person', title: '联系人', align: 'left'},
                {field: 'contact_phone', title: '联系电话', align: 'left'},
                ...
                {field: 'default_lang', title: '默认语言', width: 120, formatter: function(value) {
                    if (!value) return '';
                ...
                {field: 'operate', title: '操作', width: 120, events: {
                    'click .btn-edit': function(e, value, row) {
                        location.href = base + '/mes/customer/edit?id=' + row.id;
                    },
                    'click .btn-del': function(e, value, row) {
                        if (confirm('确定要删除吗？')) {
                            $.post(base + '/mes/customer/del', {ids: row.id}, function(r) {
                                if (r.code == 1) {
                    ...
                    return '<a href="' + base + '/mes/customer/edit?id=' + row.id + '" class="btn btn-xs btn-success btn-edit">编辑</a> ' +
        ...
        $(document).off('click', '#toolbar .btn-edit').on('click', '#toolbar .btn-edit', function() {
            ...
            location.href = base + '/mes/customer/edit?id=' + rows[0].id;
        });
        ...
        $(document).off('click', '#toolbar .btn-del').on('click', '#toolbar .btn-del', function() {
            ...
            $.post(base + '/mes/customer/del', {ids: ids.join(',')}, function(r) {
                if (r.code == 1) {
                    table.bootstrapTable('refresh');
                    alert(r.msg || '删除成功');
                } else {
