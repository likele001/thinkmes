<?php /*a:1:{s:58:"/www/wwwroot/thinkmes/app/admin/view/mes/supplier/add.html";i:1770960647;}*/ ?>
<form id="form-add" class="form-horizontal" role="form" action="" method="post">
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-name" class="form-control" name="row[name]" value="" data-rule="required" placeholder="请输入供应商名称">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">供应商编码</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-code" class="form-control" name="row[code]" value="" placeholder="请输入供应商编码">
        </div>
    </div>
    <div class="form-group">
