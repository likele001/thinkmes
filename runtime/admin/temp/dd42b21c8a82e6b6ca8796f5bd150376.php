<?php /*a:1:{s:62:"/www/wwwroot/thinkmes/app/admin/view/mes/quality/standard.html";i:1771056844;}*/ ?>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?php echo url('/admin/mes/quality/addStandard'); ?>" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> 添加标准</a>
                    <form id="form-search" class="form-inline ml-2" action="<?php echo url('mes/quality/standard'); ?>" method="get">
...
$(function() {
    ...
    table.bootstrapTable({
        url: '<?php echo url("mes/quality/standard"); ?>',
        method: 'get',
        pagination: true,
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function(value, row, index) {
                    var html = '';
                    html += '<a href="<?php echo url("mes/quality/addStandard"); ?>?id=' + value + '" class="btn btn-xs btn-primary" title="编辑"><i class="fas fa-edit"></i></a> ';
                    return html;
                }
            }
        ],
