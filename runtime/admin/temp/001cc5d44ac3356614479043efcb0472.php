<?php /*a:1:{s:62:"/www/wwwroot/thinkmes/app/admin/view/mes/allocation/batch.html";i:1771547015;}*/ ?>
        ...
        <form id="form-batch" method="post" class="form-horizontal">
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <select name="order_id" class="form-control" id="order_id" required>
                        ...
                        <option value="<?php echo htmlentities((string) $key); ?>"<?php if(isset($order_id) && $order_id == $key): ?> selected<?php endif; ?>><?php echo htmlentities((string) $vo); ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <input type="hidden" name="plan_id" id="plan_id" value="<?php echo htmlentities((string) (isset($plan_id) && ($plan_id !== '')?$plan_id:'')); ?>">
            ...
            <div class="form-group row">
                <div class="col-sm-8 offset-sm-2">
                    <button type="button" id="btn-submit-batch" class="btn btn-primary">批量分配</button>
...
(function() {
    function initForm() {
        ...
        processList[<?php echo htmlentities((string) $key); ?>] = '<?php echo htmlentities((string) $vo); ?>';
        <?php endforeach; endif; else: echo "" ;endif; if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        userList[<?php echo htmlentities((string) $key); ?>] = '<?php echo htmlentities((string) $vo); ?>';
        <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        // 点击按钮提交（避免表单submit触发其他全局事件导致提交两次）
