    ...
    <div class="card-body">
        <form id="form-audit" method="post" action="<?php echo htmlentities((string) $config['moduleurl']); ?>/mes/report/audit">
            ...
            <div class="form-group">
                <label>审核图片</label>
                <div>
                    <input type="file" id="audit-images-input" class="form-control" accept="image/*" multiple>
            ...
            <div class="form-group">
                <label>审核视频</label>
                <div>
                    <input type="file" id="audit-videos-input" class="form-control" accept="video/*" multiple>
