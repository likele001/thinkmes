<?php /*a:1:{s:54:"/www/wwwroot/thinkmes/app/admin/view/member/index.html";i:1769948892;}*/ ?>
<div class="card panel-intro">
    <div class="card-header">
        <div class="panel-lead"><em>用户管理</em> 管理C端用户（注册/登录/会员）</div>
    </div>
    <div class="card-body">
        <div id="toolbar" class="toolbar mb-2">
            ...
            <a href="<?php echo url('member/add'); ?>" class="btn btn-success btn-add" title="添加"><i class="fas fa-plus"></i> 添加用户</a>
