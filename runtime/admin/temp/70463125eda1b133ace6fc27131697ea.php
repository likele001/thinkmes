<?php /*a:1:{s:68:"/www/wwwroot/thinkmes/app/admin/view/mes/customer_product/index.html";i:1771762244;}*/ ?>
<div class="card panel-intro">
    <div class="card-header">
        <div class="panel-lead"><em>客户产品配置</em> 为客户配置可下单的产品型号</div>
    </div>
    <div class="card-body">
        <div id="toolbar" class="toolbar mb-2">
            ...
            <a href="<?php echo htmlentities((string) $config['moduleurl']); ?>/mes/customer_product/add" class="btn btn-success btn-add" title="添加"><i class="fas fa-plus"></i> 添加配置</a>
