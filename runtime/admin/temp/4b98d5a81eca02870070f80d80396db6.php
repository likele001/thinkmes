<?php /*a:1:{s:53:"/www/wwwroot/thinkmes/app/admin/view/admin/index.html";i:1769852536;}*/ ?>
<div class="card panel-intro">
    <div class="card-header">
        <div class="panel-lead"><em>管理员管理</em> 管理后台管理员账号</div>
    </div>
    <div class="card-body">
        <div id="toolbar" class="toolbar mb-2">
            ...
            <a href="<?php echo url('admin/add'); ?>" class="btn btn-success btn-add" title="添加"><i class="fas fa-plus"></i> 添加</a>
