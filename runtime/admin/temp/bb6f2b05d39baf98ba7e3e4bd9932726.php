...
<div class="card panel-intro">
    ...
    <div class="card-body">
        <div id="toolbar" class="toolbar mb-2">
            ...
            <a href="<?php echo htmlentities((string) $config['moduleurl']); ?>/mes/report/add" class="btn btn-success btn-add" title="添加"><i class="fas fa-plus"></i> 添加报工</a>
...
(function initReportPage() {
    ...
    $(function() {
        ...
        function fmtQuality(v, row) {
            if (row.status === 0 || v === null || v === undefined) {
        ...
        table.bootstrapTable({
            ...
            columns: [
                ...
                {field: 'quality_status', title: '质量', width: 100, formatter: fmtQuality},
                {field: 'create_time', title: '报工时间', width: 180, formatter: fmtTime},
